...
#include "rb_plugin.h"
	...
	#define REALSetPropValuePtr REALSetPropValue
...
REALmethodDefinition *ConvertCurrentMethodsToV6(REALmethodDefinition *inMethods, long count)
{
	#if TARGET_OS_MAC
...
{
	struct RBInternalStringData {
		long mPrivateUsageCount;
		unsigned char *mPrivateStringData;
		long mPrivateAllocLength;
		size_t mPrivateLength;
	};

	if (not str)	return NULL;
	if (numBytes)	*numBytes = ((RBInternalStringData *)str)->mPrivateLength;
	return (void *)(((RBInternalStringData *)str)->mPrivateStringData + 1);
}
...
void REALRegisterDatabaseConnection(REALDatabaseConnectionDefinition *defn)
{
	...
	if (pRegisterDatabaseConnection) {
	#ifdef USECALLSHELL
	pRegisterDatabaseConnection((REALDatabaseConnectionDefinition *)buildEnvironmentShell(defn));
	#else
...
{
	static REALobject (*pNewVariantUInt64)(unsigned RBInt64) = nil;
	if (!pNewVariantUInt64)
		pNewVariantUInt64 = (REALobject (*)(unsigned RBInt64)) CallResolver("UInt64ToVariant");
...
Boolean REALGetPropValueUInt64(REALobject object, const char *param, unsigned RBInt64 *value)
{
	static long (*pGetPropValue)(REALobject, const char *, unsigned RBInt64 *) = nil;
	if (!pGetPropValue)
		pGetPropValue = (long (*)(REALobject, const char *, unsigned RBInt64 *)) CallResolver("REALGetPropValueUInt64");
...
Boolean REALSetPropValueUInt64(REALobject object, const char *name, unsigned RBInt64 value)
{
	static long (*pSetPropValue)(REALobject, const char *, unsigned RBInt64) = nil;
	if (!pSetPropValue)
		pSetPropValue = (long (*)(REALobject, const char *, unsigned RBInt64)) CallResolver("REALSetPropValueUInt64");
	if (pSetPropValue) return (Boolean)pSetPropValue(object, name, value);
	else return (Boolean)0;
}
...
void REALInsertArrayValueUInt64( REALarray arr, long index, unsigned RBInt64 value )
{
	...
	if (!pInsertArrayValueProc)
		pInsertArrayValueProc = (void *(*)(REALarray )) CallResolver( "RuntimeArrayDirectGetInsertProc" );
	if (pInsertArrayValueProc)	{
		void (*fp)( REALarray, long, unsigned RBInt64 ) = (void (*)(REALarray, long, unsigned RBInt64))pInsertArrayValueProc( arr );
		if (fp)	fp( arr, index, value );
	}
}
...
void REALGetArrayValueUInt64( REALarray arr, long index, unsigned RBInt64 *value )
{
	...
	if (!pGetArrayValueProc)
		pGetArrayValueProc = (void *(*)(REALarray )) CallResolver( "RuntimeArrayDirectGetGetProc" );
	if (pGetArrayValueProc)	{
		unsigned RBInt64 (*fp)( REALarray, long ) = (unsigned RBInt64 (*)(REALarray, long))pGetArrayValueProc( arr );
		if (fp && value)	*value = fp( arr, index );
	}
}
...
void REALSetArrayValueUInt64( REALarray arr, long index, unsigned RBInt64 value )
{
	...
	if (!pSetArrayValueProc)
		pSetArrayValueProc = (void *(*)(REALarray )) CallResolver( "RuntimeArrayDirectGetSetProc" );
	if (pSetArrayValueProc)	{
		void (*fp)( REALarray, unsigned RBInt64, long ) = (void (*)(REALarray, unsigned RBInt64, long))pSetArrayValueProc( arr );
		if (fp)	fp( arr, value, index );
	}
}
...
#if TARGET_COCOA
void *REALGetWindowHandle(REALwindow window)
{
	...
	if (pGetWindowHandle) return (void *)pGetWindowHandle(window);
	else return (void *)0;
}
#endif
...
#if TARGET_COCOA
void *REALGetControlHandle(REALcontrolInstance control)
{
	...
	if (pGetControlHandle) return (void *)pGetControlHandle(control);
	else return (void *)0;
}
#endif
