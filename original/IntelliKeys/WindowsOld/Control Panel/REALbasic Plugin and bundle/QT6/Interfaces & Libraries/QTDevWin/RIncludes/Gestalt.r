...
#define gestaltControlMgrPresent 		0x00000001
...
#define gestaltCPUPentiumIII 			'i5_3'
#define gestaltCPUPentium4 				'i5_4'
...
#define gestaltDialogMgrPresent 		0x00000001
...
#define gestaltFBCCurrentVersion 		0x0011				/*  First release  */
...
#define gestaltUSBCosmoANSIKbd 			198					/*  (0xC6) Cosmo USB Domestic (ANSI) Keyboard  */
#define gestaltUSBCosmoISOKbd 			199					/*  (0xC7) Cosmo USB International (ISO) Keyboard  */
#define gestaltUSBCosmoJISKbd 			200					/*  (0xC8) Cosmo USB Japanese (JIS) Keyboard  */
...
#define gestaltMenuMgrPresent 			0x00000001			/*  NOTE: this is a bit mask, where all other Gestalt constants of this nature  */
															/*  are bit index values. 3.2 interfaces slipped out with this mistake unnoticed.  */
															/*  Sincere apologies for any inconvenience.  */
#define gestaltMenuMgrPresentMask 		0x00000001			/*  bit mask  */
...
#define gestaltWindowMgrPresent 		0x00000001			/*  NOTE: this is a bit mask, where all other Gestalt constants of */
...
#define gestaltX86HasPSN 				18					/*  supports PSN, PSN_DISABLE MSR */
#define gestaltX86HasCLFL 				19					/*  supports CLFLUSH instruction */
#define gestaltX86HasDTES 				21					/*  supports Debug Trace and EMON Store MSRs */
#define gestaltX86HasACPI 				22					/*  supports IA32_THERM_* MSRs, xAPIC thermal LVT entry */
...
#define gestaltX86HasSSE 				25					/*  supports Streaming SIMD Extensions (aka. Katmai New Instructions; aka. Floating point vector instructions) */
#define gestaltX86HasSSE2 				26					/*  supports even more Streaming SIMD Extensions */
#define gestaltX86HasSS 				27					/*  supports "selfsnoop" */
#define gestaltX86HasHTT 				28					/*  supports Hyper-Threading Technology */
#define gestaltX86HasTM 				29					/*  supports IA32_THERM_* MSRs, xAPIC thermal LVT entry */
#define gestaltX86HasIA64 				30					/*  supports IA-64, JMPE Jv, JMPE Ev */
