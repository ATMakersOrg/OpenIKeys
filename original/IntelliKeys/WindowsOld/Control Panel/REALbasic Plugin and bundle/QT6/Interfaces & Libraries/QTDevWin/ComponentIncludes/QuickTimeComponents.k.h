...
*/
	...
	EXTERN_API( VideoDigitizerError  ) ADD_VDIIDC_BASENAME(GetCSRData) (VDIIDC_GLOBALS() ADD_VDIIDC_COMMA Boolean  offsetFromRegisterBase, UInt32  offset, UInt32 * data);
	EXTERN_API( VideoDigitizerError  ) ADD_VDIIDC_BASENAME(SetCSRData) (VDIIDC_GLOBALS() ADD_VDIIDC_COMMA Boolean  offsetFromRegisterBase, UInt32  offset, UInt32  data);
	/* MixedMode ProcInfo constants for component calls */
	enum {
