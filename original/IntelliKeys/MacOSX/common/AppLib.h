...
int		AppLibAddApplication		( const TCHAR * AppPath );
int		AppLibRemoveApplication		( const TCHAR * AppPath, const TCHAR * SystemName );
int		AppLibTakeOwnership			( const TCHAR * AppPath, const TCHAR * SystemName );
int		AppLibHasOwnership			( const TCHAR * AppPath, const TCHAR * SystemName);
TCHAR *	AppLibGetOwner				( const TCHAR * AppPath );
...
bool	AppLibUnlock				();
TCHAR *	AppLibGetAppFriendlyName	( const TCHAR * AppPath );
